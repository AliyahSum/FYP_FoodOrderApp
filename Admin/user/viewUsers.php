...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="btn btn-outline-success addnav" href="/FYP_FoodOrderApp/Admin/user/addUsers.php">Add Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-outline-danger backnav" href="/FYP_FoodOrderApp/Admin/user/viewDeletedUser.php">Deleted Users</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <table id="userTable" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="get" action="/FYP_FoodOrderApp/Admin/user/editUsers.php">
        ...
        <div class="d-flex justify-content-center">
            <a class="btn btn-success" href="/FYP_FoodOrderApp/Admin/user/addUsers.php">Add New Users</a>
        </div>
    </div>
