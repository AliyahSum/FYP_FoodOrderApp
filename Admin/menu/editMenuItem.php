...
<html lang="en">
    ...
    <body>
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <form id="postReview" method="post" action="../../Admin/menu/doEditMenuItem.php" enctype="multipart/form-data">
                ...
                <img src="../../images/<?php echo $row['image'] ?>" alt="Current Image" width="200"><br>
                ...
                <div class="avail" class="heading">
                    Availability:
                    <label class="switch">
                        <input type="checkbox" id="availability" name="availability" <?php echo ($row['isAvailable'] == 1) ? 'checked' : ''; ?> onchange="setAvail()">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        checkbox.addEventListener('change', setAvail);

        const availInt = checkbox.checked ? 1 : 0;
