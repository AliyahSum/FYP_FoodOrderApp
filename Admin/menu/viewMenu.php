    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="btn btn-outline-success addnav" href="../../Admin/menu/addMenuItem.php">Add Menu Item</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-outline-danger backnav" href="../../Admin/menu/viewDeletedMenu.php">Deleted Menu Items</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <table id="menuTable" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="get" action="../../Admin/menu/editMenuItem.php">
            ...
            <div class="d-flex justify-content-center">
                <a class="btn btn-success" href="../../Admin/menu/addMenuItem.php">Add New Food Item</a>
            </div>
        </div>
