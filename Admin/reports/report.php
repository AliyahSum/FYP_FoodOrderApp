    ...
    <body>
        ...
        <script>
            function navigateToReport1() {
                window.location.href = "../../Admin/reports/report1Month.php";
            }
            function navigateToReport2() {
                window.location.href = "../../Admin/reports/report2.php";
            }
            function navigateToReport3() {
                window.location.href = "../../Admin/reports/report3.php";
            }
            function navigateToReport4() {
                window.location.href = "../../Admin/reports/report4.php";
            }
            function navigateToReport5() {
                window.location.href = "../../Admin/reports/report5.php";
            }
