...
<body>
    ...
    <div class="container form-container">
        ...
        <form method="post" action="/FYP_FoodOrderApp/Login/doForgotPassword.php">
            <div class="mb-3">
    ...
    <script>
            ...
            window.location.href = "/FYP_FoodOrderApp/index.php"; // Change "kitchen.html" to the actual URL of the next page
        }
    </script>
