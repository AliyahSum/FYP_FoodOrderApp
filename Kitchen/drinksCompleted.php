...
$query = "SELECT *
        ...
        WHERE orders.orderStatusDrink = 1 AND stationID = 'STN1';";
...
<html lang="en">
    <head>
        ...
        <title>Drinks Completed Orders Page</title>
        <style>
                                body {
            padding-top: 120px;
    ...
    <body>
        ...
        <div class="container position-relative d-flex justify-content-center">
            ...
            <div class="navbar-brand">Compeleted Orders - Drink</div>
        </div>
    </nav>
        <div class="container">
            <!-- Navigation Buttons -->
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.min.js"></script>
            <script>
                        ...
                        function confirmClear() {
                            if (confirm("Are you sure you want to clear all completed orders?")) {
                                $.post('/FYP_FoodOrderApp/Kitchen/clearOrders.php', {clear1: true}, function (response) {
        ...
        if (!confirm('Are you sure you want to clear completed orders?')) {
            event.preventDefault();
                            ...
                            window.location.href = "/FYP_FoodOrderApp/Kitchen/drinks.php"; // Change "kitchen.html" to the actual URL of the next page
                        }
